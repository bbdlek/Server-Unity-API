namespace MVS.Realtime
{
    public class EventCode {
        ...
        public const int PKT_S_OTHER_CLIENT_JOINED = (int)Protocol.EventCode.OtherClientJoined;
        ...
        public const int PKT_C_CHANGE_OBJECTS_OWNER = (int)Protocol.EventCode.ChangeObjectsOwner;
        public const int PKT_S_CHANGE_OBJECTS_OWNER = (int)Protocol.EventCode.ChangeObjectsOwner;
    }
}